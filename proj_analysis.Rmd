...
coal_ts <- ts(coal_full$consumption, start = c(2000, 1), frequency = 4)
...
petroleum_sarima <- sarima(petroleum_train, p = 4, d = 2, q = 1, P = 3, D = 1, Q = 1, S = 12)
petroleum_sarima
...
petroleum_forecast <- sarima.for(xdata = petroleum_train, n.ahead = 20, p = 4, d = 2, q = 1, P = 3, D = 1, Q = 1, S = 12, plot = TRUE)
```
